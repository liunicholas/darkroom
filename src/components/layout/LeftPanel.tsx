    ...
    <div className="w-64 bg-dark-800 border-r border-dark-400 flex flex-col shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-2 custom-scrollbar">
        ...
        <button
          disabled={!imageSource}
          className={`
            w-full px-3 py-2 text-sm rounded-md border border-dashed border-dark-400 transition-colors
            ${imageSource
              ? 'text-gray-400 hover:text-white hover:bg-dark-600 hover:border-gray-500'
